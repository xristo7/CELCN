...
import { Baby, Buildings, ChatCircleDots, CurrencyDollar, EnvelopeSimple, Info, Path } from "@phosphor-icons/react";

const links = [["About us", "/about", Info], ["Chapters", "/chapters", Buildings], ["How it works", "/how-it-works", Path], ["Pricing", "/pricing", CurrencyDollar], ["Contact us", "/contact", ChatCircleDots]];
const mobileLinks = [links[0], ["Programs", "/#programs", Baby], ...links.slice(1)];
