...
export function ClientSections({ onEnquire }) {
  ...
  return <>
    ...
    <section className="network-section section" id="chapters" aria-labelledby="network-title"><div><p className="kicker">Local connections. Shared purpose.</p><h2 id="network-title">A network rooted<br />in community.</h2><p>CELCN’s chapter planning starts with communities in Ontario. Explore a conversation about local participation or the platform for your organisation.</p><button className="text-link link-button" onClick={onEnquire}>Connect with CELCN</button></div><div className="chapter-list"><article><span>Ontario</span><h3>Ottawa</h3><p>Roydon Avenue</p></article><article><span>Ontario</span><h3>Hamilton</h3><p>191 King Williams Street</p><a className="text-link" href="/about#hamilton-chapter">Meet the chapter</a></article><small>Explore the Hamilton chapter’s directors and contact details. Ottawa service availability is to be confirmed.</small></div></section>
